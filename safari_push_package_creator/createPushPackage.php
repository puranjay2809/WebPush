...
$certificate_path = "{path to your .p12 certificate}";     // Change this to the path where your certificate is located
$certificate_password = "{password to .p12 certificate}"; // Change this to the certificate's import password
...
function create_signature($package_dir, $cert_path, $cert_password) {
    ...
    openssl_pkcs7_sign("$package_dir/manifest.json", $signature_path, $cert_data, $private_key, array(), PKCS7_BINARY | PKCS7_DETACHED, "/Users/pjay/Desktop/safari_push_package_creator/intermediate.pem");
...
function create_push_package() {
    ...
    $package_dir = '/Users/puranjay/Documents/Web-Push-Example/safari_push_package_creator/tmp/pushPackage';
